...
const messages = {
  uk: {
    ...
    waitingRate: 'Оплата за час / год', minimumFare: 'Мінімальна ціна', currency: 'Валюта',
  ...
  en: {
    ...
    waitingRate: 'Time tariff / hour', minimumFare: 'Minimum fare', currency: 'Currency', save: 'Save',
