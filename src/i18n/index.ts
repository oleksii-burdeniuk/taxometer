...
const messages = {
  uk: {
    ...
    taxiProfile: 'Дані таксі', driverVehicleLicense: 'Водій, автомобіль і ліцензія', taxiProfileHint: 'Необов’язкові дані для роботи та документів',
    taxiProfileDescription: 'Заповнюйте лише потрібні поля. Цей профіль не замінює ліцензію, виписку з ліцензії чи посвідчення водія.', optional: 'Необов’язково',
    companyData: 'Дані компанії', companyName: 'Назва компанії', companyNamePlaceholder: 'Підприємець або компанія', companyAddress: 'Адреса компанії', companyAddressPlaceholder: 'Вулиця, місто, поштовий індекс', companyPhone: 'Телефон компанії', companyRegistry: 'Реєстр', companyRegistryNumber: 'Номер у реєстрі',
    driverData: 'Дані водія', driverName: 'Ім’я та прізвище', driverNamePlaceholder: 'Ім’я водія', driverIdentifier: 'Ідентифікатор водія таксі', driverIdentifierPlaceholder: 'Номер ідентифікатора', driverPhone: 'Телефон',
    vehicleData: 'Дані автомобіля', vehicleMake: 'Марка', vehicleModel: 'Модель / тип', registrationNumber: 'Реєстраційний номер', vehicleVin: 'VIN', vehicleSideNumber: 'Бортовий номер', vehicleSideNumberPlaceholder: 'Наприклад, номер Kraków TAXI',
    taxiLicense: 'Ліцензія таксі', licenseHolderName: 'Власник ліцензії / назва компанії', licenseHolderPlaceholder: 'Підприємець або компанія', licenseNumber: 'Номер ліцензії', licenseExtractNumber: 'Номер виписки', issuingAuthority: 'Орган, що видав ліцензію', issuingAuthorityPlaceholder: 'Наприклад, Prezydent Miasta Krakowa', licenseArea: 'Територія дії', licenseAreaPlaceholder: 'Місто або об’єднання громад', licenseValidUntil: 'Дійсна до', datePlaceholder: 'ДД.ММ.РРРР',
    taxiProfilePrivacy: 'Дані зберігаються локально на цьому пристрої. Не додавайте фото документів або медичні дані.', saveData: 'Зберегти дані', dataSaved: 'Дані збережено', clearData: 'Очистити дані', clearTaxiProfileTitle: 'Очистити дані таксі?', clearTaxiProfileBody: 'Усі введені дані водія, автомобіля та ліцензії буде видалено з цього пристрою.',
    dataControls: 'Використання та доступ', includeTaxiDataOnReceipt: 'Додавати дані до чека', includeTaxiDataOnReceiptHint: 'Нові чеки зберігатимуть знімок компанії, водія, авто та ліцензії.', allowTaxiDataEditing: 'Дозволити редагування даних', allowTaxiDataEditingHint: 'Коли вимкнено, поля профілю доступні лише для перегляду.', allowReceiptDeletion: 'Дозволити видалення чеків', allowReceiptDeletionHint: 'Коли вимкнено, видалення поїздок і чеків недоступне.',
    managedMode: 'Керований профіль', managedModeHint: 'Симуляція даних і тарифів, призначених менеджером флоти.', managedProfile: 'Керований', localProfile: 'Локальний', managedProfileHint: 'Профіль, тарифи та чеки заблоковані для редагування. Вимкніть керований режим, щоб повернути локальне керування.', managedTariffsHint: 'Тарифи призначені менеджером флоти й доступні лише для перегляду.', invalidCompanyData: 'Перевірте дані компанії', invalidNip: 'Введіть правильний польський NIP із 10 цифр або залиште поле порожнім.',
    invalidLicenseDate: 'Введіть дату завершення ліцензії у форматі ДД.ММ.РРРР або залиште поле порожнім.', licenseValid: 'Ліцензія чинна', licenseExpiresSoon: 'Ліцензія завершується протягом 30 днів', licenseExpired: 'Строк дії ліцензії завершився',
  ...
  en: {
    ...
    taxiProfile: 'Taxi details', driverVehicleLicense: 'Driver, vehicle and licence', taxiProfileHint: 'Optional details for operations and documents',
    taxiProfileDescription: 'Complete only the fields you need. This profile does not replace a taxi licence, licence extract or driving licence.', optional: 'Optional',
    companyData: 'Company details', companyName: 'Company name', companyNamePlaceholder: 'Sole trader or company', companyAddress: 'Company address', companyAddressPlaceholder: 'Street, city and postal code', companyPhone: 'Company phone', companyRegistry: 'Registry', companyRegistryNumber: 'Registry number',
    driverData: 'Driver details', driverName: 'Full name', driverNamePlaceholder: 'Driver name', driverIdentifier: 'Taxi driver identifier', driverIdentifierPlaceholder: 'Identifier number', driverPhone: 'Phone',
    vehicleData: 'Vehicle details', vehicleMake: 'Make', vehicleModel: 'Model / type', registrationNumber: 'Registration number', vehicleVin: 'VIN', vehicleSideNumber: 'Taxi side number', vehicleSideNumberPlaceholder: 'For example, Kraków TAXI number',
    taxiLicense: 'Taxi licence', licenseHolderName: 'Licence holder / company name', licenseHolderPlaceholder: 'Sole trader or company', licenseNumber: 'Licence number', licenseExtractNumber: 'Extract number', issuingAuthority: 'Issuing authority', issuingAuthorityPlaceholder: 'For example, Mayor of Kraków', licenseArea: 'Licensed area', licenseAreaPlaceholder: 'Municipality or group of municipalities', licenseValidUntil: 'Valid until', datePlaceholder: 'DD.MM.YYYY',
    taxiProfilePrivacy: 'Details are stored locally on this device. Do not add document photos or medical information.', saveData: 'Save details', dataSaved: 'Details saved', clearData: 'Clear details', clearTaxiProfileTitle: 'Clear taxi details?', clearTaxiProfileBody: 'All entered driver, vehicle and licence details will be removed from this device.',
    dataControls: 'Use and access', includeTaxiDataOnReceipt: 'Add details to receipts', includeTaxiDataOnReceiptHint: 'New receipts will keep a snapshot of company, driver, vehicle and licence details.', allowTaxiDataEditing: 'Allow details to be edited', allowTaxiDataEditingHint: 'When disabled, profile fields are read-only.', allowReceiptDeletion: 'Allow receipt deletion', allowReceiptDeletionHint: 'When disabled, trips and their receipts cannot be deleted.',
    managedMode: 'Managed profile', managedModeHint: 'Simulate data and tariffs assigned by a fleet manager.', managedProfile: 'Managed', localProfile: 'Local', managedProfileHint: 'Profile, tariffs and receipts are locked. Disable managed mode to restore local controls.', managedTariffsHint: 'Tariffs are assigned by the fleet manager and are read-only.', invalidCompanyData: 'Check company details', invalidNip: 'Enter a valid 10-digit Polish NIP or leave the field empty.',
    invalidLicenseDate: 'Enter the licence expiry date as DD.MM.YYYY or leave the field empty.', licenseValid: 'Licence is valid', licenseExpiresSoon: 'Licence expires within 30 days', licenseExpired: 'Licence has expired',
  ...
  pl: {
    ...
    taxiProfile: 'Dane taksówki', driverVehicleLicense: 'Kierowca, pojazd i licencja', taxiProfileHint: 'Opcjonalne dane do pracy i dokumentów',
    taxiProfileDescription: 'Uzupełnij tylko potrzebne pola. Ten profil nie zastępuje licencji taxi, wypisu z licencji ani prawa jazdy.', optional: 'Opcjonalnie',
    companyData: 'Dane firmy', companyName: 'Nazwa firmy', companyNamePlaceholder: 'Przedsiębiorca lub firma', companyAddress: 'Adres firmy', companyAddressPlaceholder: 'Ulica, miasto i kod pocztowy', companyPhone: 'Telefon firmy', companyRegistry: 'Rejestr', companyRegistryNumber: 'Numer w rejestrze',
    driverData: 'Dane kierowcy', driverName: 'Imię i nazwisko', driverNamePlaceholder: 'Imię i nazwisko kierowcy', driverIdentifier: 'Identyfikator kierowcy taxi', driverIdentifierPlaceholder: 'Numer identyfikatora', driverPhone: 'Telefon',
    vehicleData: 'Dane pojazdu', vehicleMake: 'Marka', vehicleModel: 'Model / typ', registrationNumber: 'Numer rejestracyjny', vehicleVin: 'VIN', vehicleSideNumber: 'Numer boczny taxi', vehicleSideNumberPlaceholder: 'Np. numer Kraków TAXI',
    taxiLicense: 'Licencja taxi', licenseHolderName: 'Posiadacz licencji / nazwa firmy', licenseHolderPlaceholder: 'Przedsiębiorca lub firma', licenseNumber: 'Numer licencji', licenseExtractNumber: 'Numer wypisu', issuingAuthority: 'Organ wydający', issuingAuthorityPlaceholder: 'Np. Prezydent Miasta Krakowa', licenseArea: 'Obszar licencji', licenseAreaPlaceholder: 'Gmina lub związek gmin', licenseValidUntil: 'Ważna do', datePlaceholder: 'DD.MM.RRRR',
    taxiProfilePrivacy: 'Dane są przechowywane lokalnie na tym urządzeniu. Nie dodawaj zdjęć dokumentów ani danych medycznych.', saveData: 'Zapisz dane', dataSaved: 'Dane zapisane', clearData: 'Wyczyść dane', clearTaxiProfileTitle: 'Wyczyścić dane taksówki?', clearTaxiProfileBody: 'Wszystkie wpisane dane kierowcy, pojazdu i licencji zostaną usunięte z tego urządzenia.',
    dataControls: 'Użycie i dostęp', includeTaxiDataOnReceipt: 'Dodawaj dane do rachunków', includeTaxiDataOnReceiptHint: 'Nowe rachunki zachowają kopię danych firmy, kierowcy, pojazdu i licencji.', allowTaxiDataEditing: 'Zezwalaj na edycję danych', allowTaxiDataEditingHint: 'Po wyłączeniu pola profilu są tylko do odczytu.', allowReceiptDeletion: 'Zezwalaj na usuwanie rachunków', allowReceiptDeletionHint: 'Po wyłączeniu nie można usuwać kursów ani ich rachunków.',
    managedMode: 'Profil zarządzany', managedModeHint: 'Symuluj dane i taryfy przypisane przez menedżera floty.', managedProfile: 'Zarządzany', localProfile: 'Lokalny', managedProfileHint: 'Profil, taryfy i rachunki są zablokowane. Wyłącz tryb zarządzany, aby przywrócić lokalną edycję.', managedTariffsHint: 'Taryfy są przypisane przez menedżera floty i dostępne tylko do odczytu.', invalidCompanyData: 'Sprawdź dane firmy', invalidNip: 'Podaj poprawny 10-cyfrowy polski NIP albo pozostaw pole puste.',
    invalidLicenseDate: 'Podaj datę ważności licencji w formacie DD.MM.RRRR albo pozostaw pole puste.', licenseValid: 'Licencja jest ważna', licenseExpiresSoon: 'Licencja wygasa w ciągu 30 dni', licenseExpired: 'Licencja straciła ważność',
